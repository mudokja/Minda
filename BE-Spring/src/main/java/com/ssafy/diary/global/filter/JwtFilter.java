...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private static final List<String> allowUrlList=List.of("/api/auth/refresh","/api/member/register","/api/auth/login","/api/member/check","/api/email/auth","/api/email/verification","/login","/favicon.ico");
    @Override
